...
import com.sg.linuxgo.shared.extrakeys.ExtraKeysView;
import com.sg.linuxgo.x11.MainActivity;
import com.sg.linuxgo.x11.R;
    ...
    public static class PageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup collection, int position) {
            ...
            if (position == 0) {
                ...
                mActivity.mExtraKeys = new X11ExtraKeys(mEventListener, mActivity, extraKeysView);
