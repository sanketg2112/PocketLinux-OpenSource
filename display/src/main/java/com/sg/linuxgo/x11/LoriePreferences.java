...
public class LoriePreferences extends AppCompatActivity implements PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {
    static final String ACTION_PREFERENCES_CHANGED = "com.sg.linuxgo.x11.ACTION_PREFERENCES_CHANGED";
                ...
                new android.app.AlertDialog.Builder(getActivity())
                        ...
                        .setPositiveButton("OK",
                                (dialog, whichButton) -> {
                                    ...
                                    prefs.extra_keys_config.put(!text.isEmpty() ? text : X11ExtraKeys.DEFAULT_IVALUE_EXTRA_KEYS);
                                }
                        )
                        .setNeutralButton("Reset",
                                (dialog, whichButton) -> prefs.extra_keys_config.put(X11ExtraKeys.DEFAULT_IVALUE_EXTRA_KEYS))
    ...
    public static class Receiver extends BroadcastReceiver {
            ...
            try {
                if (intent != null && intent.getExtras() != null) {
                    ...
                    for (String key : intent.getExtras().keySet()) {
                        ...
                        intent0.setPackage(BuildConfig.APPLICATION_ID);
        ...
        private static void help() {
            System.err.print("linuxgo-x11-preference [list] {key:value} [{key2:value2}]...");
            System.exit(0);
        }
        ...
        public static void main(String[] args) {
            ...
            Intent i = new Intent("com.sg.linuxgo.x11.CHANGE_PREFERENCE");
